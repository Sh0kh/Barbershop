     ...
     <LogoUse/>
            <div className="flex items-center mb-8">
                ...
                <div className="flex-1">
                    <h1 className="font-bold text-lg">Детали записи</h1>
                </div>
           ...
           <div className="mb-8 flex items-center justify-start gap-[10px]">
                <div>
                    <img className='barber_img w-14 h-14 mr-[5px]  rounded-full object-cover ' src="https://randomuser.me/api/portraits/men/32.jpg" alt="" />
                </div>
                <div> <h2 className="font-bold text-xl mb-1">Анастасия (Anastacija)</h2>
                <p className="text-gray-600 text-base">Барбер</p></div>
           ...
           <div className="mb-8 flex items-center justify-start gap-[10px]">
                ...
                <div> <h2 className="font-medium text-gray-900">Пятница, 9 мая</h2>
                <p className="text-gray-600 text-base">10:30 — 11:30</p></div>
            ...
            <div className=" mb-8">
                <h3 className="font-bold text-lg mb-4 border-t pt-[10px] ">Услуги <span className="font-normal text-gray-600">1 ч.</span></h3>
                
                <div className=" border-b border-gray-200 py-4">
                    <div className="flex justify-between items-center mb-1">
                        <span className="text-gray-900">Классическая стрижка + укладка</span>
                        <span className="text-gray-600">1 ч</span>
                    </div>
                    <div className="flex justify-between">
                        <span className="text-gray-500 text-sm">180 000 сум</span>
                    </div>
                </div>

...
export default function BarberWorkTimeEdit({ isOpen, onClose, data, refresh }) {
    ...
    const handleSave = async () => {
        try {
            ...
            const response = await $api.patch(`worktime/${data?.id}`, newData)
            Swal.fire({
    ...
    return (
        <>
            <Dialog
                ...
                open={isOpen} size="xl" handler={onClose} >

        ...
        <div className="w-[78%] p-[10px] fixed rounded-[10px] bg-[white] shadow-lg">
            <div className="w-full flex items-center justify-between">
                ...
                <div>
                    <button
                        onClick={Exit}
                        className="bg-black flex items-center gap-[5px] text-[white] px-[20px] py-[8px] rounded-[10px] shadow-xl  duration-500 hover:text-black hover:border-[2px] hover:border-black hover:bg-transparent">
                        Chiqish

...
export default function AdminBarbersWorkTimeDelete({ isOpen, onClose, id, refresh }) {
    const handleDelete = async () => {
        try {
            await $api.delete(`work-schedules/${id}`); // Убедитесь, что путь правильный
        ...
        <Dialog open={isOpen} handler={onClose} size="sm" className="rounded-lg shadow-lg">
            ...
            <DialogBody divider>
                <p className="text-sm text-gray-700 font-medium">
                    Siz ushbu ish vaqtini o'chirmoqchimisiz?
                </p>
            </DialogBody>
